      ...
      def delete(self):
            ...
            try:
                  if self.var_course.get()=="":
                        messagebox.showerror("Error",f"course name is Should be required", parent=self.root)
                  else:
                        cursor.execute("SELECT * FROM course  where name=?",(self.var_course.get(),) )
                        row=cursor.fetchone()
                        if row is None:
                              messagebox.showerror("Error",f"Please select Course from the list ", parent=self.root)
                        else:
      ...
      def add(self):
            ...
            try:
                  if self.var_course.get()=="":
                        ...
                        row=cursor.fetchone()
                        if row!=None:
                              messagebox.showerror("Error",f"Course Name is already present ", parent=self.root)
                        else:
      ...
      def update(self):
            ...
            try:
                  if self.var_course.get()=="":
                        ...
                        row=cursor.fetchone()
                        if row==None:
                              messagebox.showerror("Error",f" Select Course Name from the List", parent=self.root)
                        else:
